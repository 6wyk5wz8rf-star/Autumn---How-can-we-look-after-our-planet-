...
export const DESTINATIONS = Object.freeze([
  {
    ...
    symbol: '◎',
    invitation: 'Turn the globe and look closer.',
    primaryModes: ['Explore', 'Compare', 'Journey', 'Portrait'],
  },
  {
    ...
    symbol: '≡',
    invitation: 'Build a number and reveal its structure.',
    primaryModes: ['Build', 'Compare', 'Calculate', 'Reason'],
  },
  {
    ...
    symbol: '⌕',
    invitation: 'Choose a living thing and notice evidence.',
    primaryModes: ['Observe', 'Group', 'Classify', 'Habitats'],
  },
  {
    ...
    symbol: '≋',
    invitation: 'Move temperature or rainfall. What changes?',
    primaryModes: ['Patterns', 'Climate Map', 'Experiment', 'Change'],
  },
  {
    id: 'materials-river',
    ordinal: 5,
    ...
    extensionPoints: ['material-objects', 'pathways', 'continued-use', 'repair', 'sharing', 'repurposing', 'sorting', 'recycling', 'landfill', 'waterways', 'habitat-effects', 'community-systems', 'quantities', 'trade-offs'],
  },
  {
    id: 'story-theatre',
    ordinal: 6,
